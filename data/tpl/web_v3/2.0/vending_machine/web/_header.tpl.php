...
<div class="wb-header" style="position: fixed;">
    <div class="logo <?php  if(!empty($system['foldnav'])) { ?>small<?php  } ?>">
        <?php  if(!empty($copyright) && !empty($copyright['logo'])) { ?>
            <img class='logo-img' src="<?php  echo tomedia($copyright['logo'])?>" onerror="this.src='../addons/vending_machine/static/images/nologo.png'"/>
        <?php  } ?>
    </div>
    <ul>
        <li>
    ...
    <ul>
		...
		<?php  if(!empty($appqrcode)) { ?>
	        <li   class="wxcode_box">
	            ...
	            <img src="../addons/vending_machine/static/images/new.gif" alt=""  style="margin-top: -10px ">
	            <div class="wx_code">
    ...
    <div class="wb-nav <?php  if(!empty($system['foldnav'])) { ?>fold<?php  } ?>">
        ...
        <ul id="navheight">
            ...
            <?php  } else { ?>
            <li class="sysset" style="display: none">
                            ...
                            <li class="panel-list">
                                ...
                                <div class="panel-list-text upmsg" style="display: none; max-height: none;">
                                    ...
                                    <div>
                                        ...
                                        <a class="text-warning" href="javascript:check_vending_machine_upgrade_hide();" style="margin-left: 15px;">暂不提醒</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
