            ...
            <div class="tab-content ">
                ...
                <div class="tab-pane  " id="tab_style">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            ...
                            <div class="help-block">您可以根据系统自带3套模板数据格式设计自己的模板上传至addons/vending_machine/template/account/目录下并且在此处设置</div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12" id="bgimg">
                            <?php if(cv('sysset.wap.edit')) { ?>
                            <?php echo tpl_form_field_image2('data[bg]', empty($data['bg'])?'../addons/vending_machine/template/account/default/bg.jpg':$data['bg'])?>
                ...
                <div class="tab-pane  " id="tab_login">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <label class="radio-inline"><input type="radio" name="data[agr]" value="1" <?php  if($data['agr'] == 1) { ?> checked<?php  } ?>> 开启</label>
                            <label class="radio-inline"><input type="radio" name="data[agr]" value="0" <?php  if(empty($data['agr'])) { ?> checked<?php  } ?>> 关闭</label>
...
<script type="text/javascript">
    ...
    $(".setimg").click(function () {
       var imgurl = $(this).data('style');
        if(imgurl){
            imgurl = "../addons/vending_machine/template/account/"+imgurl+"/bg.jpg";
