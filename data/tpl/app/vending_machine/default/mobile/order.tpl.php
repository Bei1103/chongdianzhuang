...
<div class='fui-page order-list-page '>
    ...
    <div id="tab" class="fui-tab fui-tab-danger">
        ...
        <a data-tab="tab0" class="external <?php  if($_GPC['status']=='0') { ?>active<?php  } ?>"  data-status='0'>进行中</a>
        <a data-tab="tab1" class="external <?php  if($_GPC['status']=='1') { ?>active<?php  } ?>"  data-status='1'>待支付</a>
        <a data-tab="tab3" class="external <?php  if($_GPC['status']=='3') { ?>active<?php  } ?>"  data-status='3'>已完成</a>
        <a data-tab="tab_1" class="external <?php  if($_GPC['status']=='-1') { ?>active<?php  } ?>"  data-status='-1'>已取消</a>
    </div>
    <?php  } ?>
