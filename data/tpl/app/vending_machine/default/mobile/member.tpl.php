...
<div class='fui-page  fui-page-current'>
	...
	<div class='fui-content member-page navbar'>
		<div style="overflow: hidden;height: 9rem;position: relative;background: #fff">
			<div class="headinfo" style="z-index:100;border: none;">
				...
				<div class="child">
					<a href="./index.php?i=<?php  echo $_W['uniacid']?>&c=entry&m=vending_machine&do=mobile&r=member.log">
				...
				<div class="child userinfo">
					<a href="<?php  echo mobileUrl('member/info')?>" data-nocache="true" style="color: white;">
						<div class="face"><img src="<?php  echo $member['avatar'];?>" onerror="this.src='../addons/vending_machine/static/images/noface.png'"/></div>
			...
			<div class="child">
				<a href="./index.php?i=<?php  echo $_W['uniacid']?>&c=entry&m=vending_machine&do=mobile&r=creditshop.creditlog">
		...
		<div class='member_card'>
			<img class='icon' src='../addons/vending_machine/static/images/icon-huangguan.png' />
		...
		<?php  } ?>
		<image class='cover-img' src='../addons/vending_machine/static/images/cover.png' />
		</div>
        ...
        <?php  if(p('task')->get_unread()) { ?>
            <div class="fui-cell-group fui-cell-click" style="border-top: 1px solid #ebebeb;border-bottom: 1px solid #ebebeb;    margin-bottom: 0.5rem;">
                <a class="fui-cell external" href="<?php  echo mobileUrl('task')?>">
                    ...
                    <style>
                        .task-red-mark{background-color: #ef6464;position: absolute;width: 6.9px;height: 6.9px;border-radius: 50%;display: block;left: 6.9rem;top: 0.69rem}
                    </style>
	...
	<div class="fui-cell-group fui-cell-click" style="margin-top: 0">
		...
		<div class="fui-icon-group selecter <?php  if($check_cycelbuy) { ?>col-5<?php  } else { ?>col-4<?php  } ?>">
			...
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('order',array('status'=>1))?>">
				...
				<div class="icon icon-orange radius"><i class="icon icon-tixian"></i></div>
				<div class="text">待支付</div>
			</a>
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('order',array('status'=>3))?>">
				<?php  if($statics['order_3']>0) { ?><div class="badge"><?php  echo $statics['order_3'];?></div><?php  } ?>
	...
	<?php  if($iccard) { ?>
	<div class="fui-cell-group fui-cell-click">
		<a class="fui-cell"  href="<?php  echo mobileUrl('iccard')?>">
			<div class="fui-cell-icon"><i class="icon icon-vipcard"></i></div>
			<div class="fui-cell-text"><p>我的IC卡</p></div>
			<div class="fui-cell-remark"></div>
		</a>
	</div>
	<?php  } ?>
	    ...
	    <div class="fui-cell-group fui-cell-click" style="display: none">
