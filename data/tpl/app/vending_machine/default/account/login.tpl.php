...
<link rel="stylesheet" type="text/css" href="../addons/vending_machine/template/account/default/style.css?v=2.0.0">
<style type="text/css">
...
<div class="fui-page">
    ...
    <div class="fui-content" >
        <div class="account-bg">
            <img src="<?php echo empty($set['wap']['bg'])?'../addons/vending_machine/template/account/default/bg.jpg':tomedia($set['wap']['bg'])?>" />
        </div>
