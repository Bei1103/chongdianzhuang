define(["biz"],
    function (biz) {
        ...
        model.put = function (id) {
            ...
            var url = "./index.php?c=site&a=entry&m=vending_machine&do=web&r=util.goods_selector.op&id=" + id + "&column=" + encodeURI($("#goods-selected-list-" + model.name).attr("data-column"));
