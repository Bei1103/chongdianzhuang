define(['jquery'], function ($) {
    ...
    biz.url = function (routes, params, merch) {
        if (merch) {
            var url = './merchant.php?c=site&a=entry&m=vending_machine&do=web&r=' + routes.replace(/\//ig, '.')
        } else {
            var url = './index.php?c=site&a=entry&m=vending_machine&do=web&r=' + routes.replace(/\//ig, '.')
        }
        if (params) {
	...
	biz.selector =  {
		...
		, set: function (obj, data) {
			...
			if(type=='image'){
				...
				html += '<img class="img-responsive img-thumbnail" src="' + data[thumb] + '" onerror="this.src=\'../addons/vending_machine/static/images/nopic.png\'" style="width:100px;height:100px;">';
    ...
    biz.selector_new = {
        ...
        search: function (searchbtn, name) {
            ...
            if (type == 'image') {
                ...
                var url = "index.php?c=site&a=entry&m=vending_machine&do=web&r=" + optionurl + "&goodsid=" + data[key] + "&selectorid=" + selectorid;
