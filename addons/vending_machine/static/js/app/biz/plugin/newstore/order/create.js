define(['core', 'tpl', 'biz/plugin/diyform'], function (core, tpl, diyform) {
    ...
    modal.caculate = function () {
        ...
        core.json('newstore/order/create/caculate', {
            ...
            if (getjson.status == 1) {
                if (modal.params.iscarry) {
                    ...
                    {
                        $('#dispatchprice_show').hide();
                    }else
                    {
                        $('#dispatchprice_show').show();
    ...
    modal.calcCouponPrice = function () {
        ...
        core.json('newstore/order/create/getcouponprice', {
    ...
    modal.submit = function (obj, token) {
        ...
        if (!modal.params.iscarry || modal.params.isvirtual) {
            ...
            if (modal.params.addressid == 0 && modal.params.opensend==1) {
        ...
        // alert(modal.params.iscarry);return false;
        ...
        var data = {
            ...
            'carrierid': modal.params.storeid,
            'addressid': modal.params.iscarry ?  0: modal.params.addressid,
        ...
        core.json('newstore/order/create/submit', data, function (ret) {
