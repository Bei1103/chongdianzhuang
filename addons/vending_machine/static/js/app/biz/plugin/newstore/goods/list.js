define(['core', 'tpl', 'biz/plugin/newstore/goods/picker'], function (core, tpl, picker) {
    var defaults = {
        keywords: '',
        isrecommand: '',
        ishot: '',
    ...
    modal.bindEvents = function () {
        $('.buy').unbind('click').click(function () {
            ...
            // console.log(modal);
           if(type==30){
                location.href=core.getUrl('newstore/trade/detail',{id:goodsid,storeid:modal.params.storeid});
                // var link=core.getUrl('newstore/trade/detail',{id:goodsid,storeid:modal.params.storeid});
                // console.log(link);
            } else {
                if($(this).data('type')!=4)
                {
    ...
    modal.getList = function () {
        ...
        core.json('newstore/goods/get_list', modal.params, function (ret) {
