define(['core', 'tpl', 'biz/plugin/newstore/goods/picker', 'biz/member/favorite', 'biz/plugin/newstore/member/cart', 'biz/plugin/diyform', 'biz/sale/coupon/couponpicker','biz/goods/wholesalePicker'], function (core, tpl, picker, favorite, cart, diyform,couponpicker,wholesalePicker) {
    var modal = {};
    modal.init = function (params) {
        ...
        $('#chosestore').click(function () {
            location.href = core.getUrl('newstore/stores/chosestore',{goodsid:modal.goodsid,istrade:0})
        });
        ...
        wholesalePicker.open({
            ...
            onConfirm: function (buyoptions) {
                ...
                if (action == 'buy') {
                    ...
                    $.router.load(core.getUrl('newstore/order/create', {
                        id: modal.goodsid,
                        iswholesale:1,
    ...
    modal.initSeckill = function () {
        ...
        $.ajax({
            url: '../addons/vending_machine/map.json', complete: function (x) {
