...
class FixQiniu_Page extends WebPage
{
    ...
    protected function handler()
    {
        ...
        // 商品表
        $goodsTable = tablename("vending_machine_goods");
        // 分类表
        $categoryTable = tablename("vending_machine_category");
        // 栏目问题表
        $questionTable = tablename('vending_machine_qa_question');
...
QUESTION;
    ...
    /**
     * 生成备份表
     * ims_vending_machine_member (原表名称)
     * 生成后
     * ims_vending_machine_member_copy_{$hash}表名 (备份表名)
    ...
    protected function log($log, $append = true)
    {
        ...
        $logPath = IA_ROOT . "/addons/vending_machine/data/backup";
