...
class Templatetool_Page extends WebPage {
	...
	{
		$items = pdo_fetchall("select typecode from ".tablename("vending_machine_member_message_template_type")." where templatecode is not null");
