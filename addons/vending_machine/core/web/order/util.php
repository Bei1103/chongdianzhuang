...
class Util_Page extends WebPage {
	...
	function saveaddress() {
		...
		$item = pdo_fetch("SELECT address FROM " . tablename('vending_machine_order') . " WHERE id = :id and uniacid=:uniacid", array(':id' => $id, ':uniacid' => $_W['uniacid']));
