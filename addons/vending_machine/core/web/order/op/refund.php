...
class Refund_Page extends WebPage {
...
//                }
        ...
        //查询退货地址
        $refund_address = pdo_fetchall('select * from '.tablename('vending_machine_refund_address').' where uniacid=:uniacid and merchid=0',array(':uniacid'=>$_W['uniacid']));
    ...
    function main() {
        ...
        $goods = pdo_fetchall("SELECT g.*, o.goodssn as option_goodssn, o.productsn as option_productsn,o.total,g.type,o.optionname,o.optionid,o.price as orderprice,o.realprice,o.changeprice,o.oldprice,o.commission1,o.commission2,o.commission3,o.commissions {$diyformfields} FROM " . tablename('vending_machine_order_goods') .
            " o left join " . tablename('vending_machine_goods') . " g on o.goodsid=g.id " . " WHERE o.orderid=:orderid and o.uniacid=:uniacid", array(':orderid' => $id, ':uniacid' => $_W['uniacid']));
        foreach ($goods as &$r) {
