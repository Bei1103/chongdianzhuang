...
class Cityexpress_Page extends WebPage {
    ...
    function main() {
        ...
        if ($_W['ispost']) {
            ...
            if (!empty($cityexpress)) {
                ...
                pdo_update('vending_machine_city_express', $data, array('id' => $cityexpress['id']));
            } else {
                pdo_insert('vending_machine_city_express', $data);
                $id = pdo_insertid();
