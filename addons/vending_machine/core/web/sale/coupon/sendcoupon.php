...
class Sendcoupon_Page extends ComWebPage {
    ...
    function main() {
        ...
        $coupons = pdo_fetchall("SELECT * FROM " . tablename('vending_machine_coupon') . " WHERE uniacid = '{$_W['uniacid']}' and merchid=0 and isfriendcoupon = 0  ORDER BY id asc");
