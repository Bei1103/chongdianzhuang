...
class Pluginsale_Page extends SystemPage {
	...
	function main() {
        ...
        $list = pdo_fetchall("SELECT gl.*,w.name as wname,p.name as pname,p.thumb,p.iscom,o.username,o.pluginid as opluginid,o.price,o.logno,o.price,o.paytype FROM " . tablename('vending_machine_system_plugingrant_log') . " as gl
                    left join ".tablename('account_wechats')." as w on w.uniacid = gl.uniacid
                    left join ".tablename('vending_machine_system_plugingrant_order')." as o on o.uniacid = gl.uniacid and o.logno = gl.logno
