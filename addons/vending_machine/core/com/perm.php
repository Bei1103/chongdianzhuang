...
//        $perm_plugin = pdo_fetch("SELECT * FROM " . tablename('vending_machine_perm_plugin') . " WHERE acid=:uniacid limit 1", array(':uniacid' => $acid));
...
//        }
    ...
    private function check($permtype = '')
    {
        ...
        $user = pdo_fetch('select u.status as userstatus,r.status as rolestatus,u.perms2 as userperms,r.perms2 as roleperms,u.roleid from ' . tablename('vending_machine_perm_user') . ' u '
    ...
    public function log($type = '', $op = '')
    {
        ...
        pdo_insert('vending_machine_perm_log', $log);
    }
...
//    }
    ...
    protected function perm_device(){
        return array(
            'text' => '设备管理',
            'main' => '浏览列表',
            'detail' => '查看详情',
