...
class PluginMobilePage extends MobilePage
{
    ...
    protected function view($template, $params = array())
    {
        ...
        $pluginTemplatePath = VENDING_MACHINE_PLUGIN . "{$plugin}" . "/template/mobile/default/";
        ...
        // 模板需要的默认参数
        $defaultParams = array(
            'basePath' => VENDING_MACHINE_LOCAL . "plugin/{$plugin}/static",
            'staticPath' => VENDING_MACHINE_LOCAL . "static/",
            'appJsPath' => VENDING_MACHINE_LOCAL . "static/js/app",
            'title' => '自动售货机',
        );
