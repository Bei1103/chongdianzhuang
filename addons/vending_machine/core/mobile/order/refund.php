...
class Refund_Page extends MobileLoginPage {
    ...
    protected function globalData() {
        ...
        $order = pdo_fetch("select id,status,price,refundid,goodsprice,dispatchprice,deductprice,deductcredit2,finishtime,isverify,`virtual`,refundstate,merchid,random_code,iscycelbuy,paytype from " . tablename('vending_machine_order') . ' where id=:id and uniacid=:uniacid and openid=:openid limit 1'
    ...
    function cancel() {
        ...
        pdo_update('vending_machine_order_refund', $change_refund, array('id' => $refundid, 'uniacid' => $uniacid));
        pdo_update('vending_machine_order', array('refundstate' => 0), array('id' => $orderid, 'uniacid' => $uniacid));
        show_json(1);
    }
    ...
    function receive(){
        ...
        pdo_update('vending_machine_order_refund', $refund_data, array('id'=>$refundid, 'uniacid' => $uniacid));
        ...
        pdo_update('vending_machine_order', $order_data, array('id'=>$orderid, 'uniacid' => $uniacid));
        show_json(1);
