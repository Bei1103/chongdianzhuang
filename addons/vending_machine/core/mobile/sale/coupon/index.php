...
class Index_Page extends MobileLoginPage {
    ...
    function main() {
        ...
        $sql = 'select * from ' . tablename('vending_machine_coupon_category') . ' where uniacid=:uniacid';
        if ($is_openmerch == 0) {
            $sql .= ' and merchid=0';
        } else {
