...
class Bind_Page extends MobileLoginPage
{
    ...
    public function main(){
        ...
        if($_W['ispost']){
            ...
            $member2 = pdo_fetch('select * from ' . tablename('vending_machine_member') . ' where mobile=:mobile and uniacid=:uniacid and mobileverify=1 limit 1', array(':mobile' => $mobile, ':uniacid' => $_W['uniacid']));
