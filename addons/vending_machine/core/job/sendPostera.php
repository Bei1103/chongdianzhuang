...
class sendPostera
{
    ...
    public function execute($queue)
    {
        ...
        //查找二维码
        $poster = pdo_fetch('select * from ' . tablename('vending_machine_postera') . ' where keyword2=:keyword and uniacid=:uniacid limit 1', array(':keyword' => $content, ':uniacid' => $_W['uniacid']));
        if (empty($poster)) {
